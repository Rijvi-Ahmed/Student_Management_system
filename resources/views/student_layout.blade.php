  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{URL::to('/student_dashboard')}}"><img src="images/logo2.svg" alt="Logo"></a>
      </div>
    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            <div class="profile">
              <img src="{{URl::to($student_details_view->student_image)}}" alt="">
            </div>
            <div class="details">
              <p class="user-name">{{strtoupper($student_details_view->student_name)}}</p>
            </div>
          </div>
          <ul class="nav">
            <!--main pages start-->
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{URL::to('/view_book')}}">
                <i class="mdi mdi-gauge menu-icon"></i>
                <span class="menu-title">View Book</span>
              </a>
            <li class="nav-item">
