...
<body class="sidebar-dark">
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{URL::to('admin_dashboard')}}"><img src="images/logo2.svg" alt="Logo"></a>
      </div>
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            ...
            <div class="details">
              <p class="user-name">Rijvi Ahmed</p>
          ...
          <ul class="nav">
            ...
            <li class="nav-item nav-category">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{URL::to('/allbook')}}">
                  <i class="mdi mdi-gauge menu-icon"></i>
                  <span class="menu-title">All Book</span>
                </a>
              </li>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{URL::to('/addbook')}}">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="sidebar_layouts">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/science')}}">Science</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/commerce')}}">Commerce</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/arts')}}">Arts</a>
                  </li>
  ...
  <!-- End custom js for this page-->
    <!--custom js for Student Delete Operation page-->
  <script>
  ...
  window.location.href = link;
      ...
      <!-- End custom js for Student Delete Operation page-->
      </script>
    <!--custom js for Teacher Delete Operation page-->
  <script>
  ...
  window.location.href = link;
      ...
      <!-- End custom js for Teacher Delete Operation page-->
      </script>
</body>
